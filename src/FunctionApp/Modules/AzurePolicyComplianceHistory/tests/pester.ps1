...
Remove-Module AzurePolicyComplianceHistory -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\AzurePolicyComplianceHistory.psd1"
Import-Module "$PSScriptRoot\..\AzurePolicyComplianceHistory.psm1" -Force
